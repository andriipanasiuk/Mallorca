...
import mallorcatour.presenter.GameViewContract;
import mallorcatour.presenter.GameViewPresenter;
 ...
 * @author Andrew
 */
public class GameFrame extends javax.swing.JFrame implements GameViewContract.View {
    ...
    private GameViewContract.Presenter presenter;

    public GameFrame() {
        initComponents();
        presenter = new GameViewPresenter();
    ...
    @Override
    public void updateUI(GameContext gameInfo, Player playerUp, Player playerDown) {
    ...
    private void dealButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_dealButtonActionPerformed
        ...
        ExecutorUtils.newSingleThreadExecutor(OnExceptionListener.EMPTY).submit(() -> {
            presenter.dealButtonPressed();
    ...
    private void passiveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_passiveButtonActionPerformed
        botActionLabel.setText("");
        enableActionButtons(false);
        presenter.passiveButtonPressed();
        synchronized (actionLock) {
            actionLock.notifyAll();
        }
    ...
    private void aggressiveButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_aggressiveButtonActionPerformed
        botActionLabel.setText("");
        enableActionButtons(false);
        presenter.aggressiveButtonPressed();
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> EventQueue.invokeLater(() -> new GameFrame().setVisible(true)));
    }
    ...
    @Override
    public void onActed(Action action, double toCall, String name, int index) {
        if(index == 0){
    ...
    @Override
    public void startHand(GameContext gameInfo, Player playerUp, Player playerDown) {
        botDealerButton.setVisible(false);
        humanDealerButton.setVisible(false);

        if (gameInfo.onButton(playerDown.getName())) {
    ...
    @Override
    public void beforeHumanAction(GameContext gameInfo) {
