...
import mallorcatour.game.situation.ShowingSpectrumListener;
import mallorcatour.grandtorino.controller.HUGameControllerExt;
import mallorcatour.grandtorino.controller.PokerPreferences;
import mallorcatour.grandtorino.mathbot.NLMathBot;
...
//    private Card predefinedRiver = Card.valueOf("5h");
    ...
    public GameFrame(LimitType limitType) {
        ...
        villainModeller = new BaseVillainModeller(limitType, DEBUG_PATH);
