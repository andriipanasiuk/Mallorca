...
import mallorcatour.grandtorino.robot.recognizer.assets.ICardAssets;
...
class PSCardRecognizer {
    ...
    List<Card> getCards(BufferedImage cardsImage, int max) {
    ...
    int getCardsCount(BufferedImage cardsImage) {
        int result = 0;
