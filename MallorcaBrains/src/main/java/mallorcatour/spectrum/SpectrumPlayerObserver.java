 ...
 * Наблюдает за игрой и строит спектр возможных карт игрока (чаще всего противника)
 * на основании его (игрока) предполагаемой модели.
 * 
