        ...
        implements RandomAccess, Cloneable, java.io.Serializable
{
     ...
     *
     * @param elementType type of elements of the array
    ...
    public NeurophArrayList(Class<E> elementType, int initialCapacity) {
        ...
        this.elementData = (E[]) Array.newInstance(elementType, initialCapacity);
        // http://stackoverflow.com/questions/529085/how-to-generic-array-creation
        // http://stackoverflow.com/questions/12147931/generic-array-creation-in-java
    }
...
//            newCapacity = minCapacity;
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        Object[] a = elementData = (E[]) Array.newInstance(elementType, arrayLength); //new Object[arrayLength];
