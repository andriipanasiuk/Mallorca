...
import static mallorcatour.equilator.PokerEquilatorBrecher.combination;

/**
 * Считает как хорошо стоят мои карты против спектра соперника.
 */
public class SpectrumEquilatorImpl implements SpectrumEquilator {

	/**
	 * Считает сколько процентов раздач я выиграю против предполагаемого спектра карт противника.
	 * Учитывает все возможные расклады до ривера (шоудауна, вскрытия карт)
	 */
	@Override
	public double strengthVsSpectrum(Card heroCard1, Card heroCard2, Card[] boardCards, Spectrum spectrum) {
