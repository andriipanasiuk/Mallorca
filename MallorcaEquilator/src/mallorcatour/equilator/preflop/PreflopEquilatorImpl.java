package mallorcatour.equilator.preflop;
...
public class PreflopEquilatorImpl implements PreflopEquilator {
	...
	@Override
	public StreetEquity equityVsRandom(Card card1, Card card2) {
	...
	@Override
	public double strengthVsSpectrum(Card heroCard1, Card heroCard2, Spectrum villainSpectrum) {
