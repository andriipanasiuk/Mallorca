 ...
 */
public class StrengthHandStateObserver extends BaseHandStateObserver implements IHoleCardsObserver {
	...
	public StrengthHandStateObserver(LimitType limitType, String hero, Equilator equilator, PreflopEquilator preflopEquilator) {
		super(hero, true);
	...
	public StrengthHandStateObserver(boolean needFullPotentialOnFlop, String hero, Equilator equilator, PreflopEquilator preflopEquilator) {
		super(hero, true);
